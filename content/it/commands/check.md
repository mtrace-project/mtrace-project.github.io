...
Il comando `mtrace check` consente di eseguire un controllo sintattico di uno o più file di test con estensione `.mt.yaml`. Il comando verifica la correttezza della sintassi dei file e segnala eventuali errori.
...
## Flags
Il comando `mtrace check` supporta i seguenti flag:
